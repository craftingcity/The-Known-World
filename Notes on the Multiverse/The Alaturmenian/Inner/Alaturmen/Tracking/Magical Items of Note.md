...
```
	...
	Entry Description: GME-003 is stored within Vault 0's Cold Storage sector, in Lounge 3's open bookshelf.
		...
		GME-003 is a large atlas bound in a furred green hide containing over a thousand pages, each of which is recently created map of a given six-square-mile area. The maps generated by GME-003 will slowly re-generate on a page over the course of 36 hours. If the map-area is unchanged over this period, the image remains unchanged. If the map-area is heavily trafficed or otherwise significantly changed, the image will be equally disrupted in those areas that have been moved.
```
