...
- While crushing a limb, the Bonebuster deals 2d8 bludgeoning damage to the character, and they will have their choice of a *Broken Arm* or a *Broken Leg*. If you are playing with [[Lingering Injuries]], reference the Bludgeoning / Force table for the effects. Otherwise, a character with a *Broken Arm* has Disadvantage on Attack Rolls, Strength Saving Throws, and Strength or Dexterity Checks, and a character with a *Broken Leg* has Disadvantage on Dexterity Saving Throws, and Strength or Dexterity Checks, and their speed is halved.
#### Beast Barracks
...
- Blind Dogs, Unusual Rodents, Mountain Cats, and even some Madwalkers are common in the Fourth level of Kailkeep.
#### False Oasis
