...
#### Stage One
At Stage One, the diseased creature experiences bouts of manic, uncontrolled violence without reason, and will develop a dark mucus they excrete in place of their other bodily fluids. Whenever the diseased creature makes an Attack against a creature that is not afflicted with the Black Blood Curse, they gain +3 to hit on that Attack. Whenever the diseased creature makes an Ability Check or Saving Throw, they roll a d8. If the result is 3 or less, they are compelled to spend their next turn attacking the nearest humanoid creature that is not afflicted with the Black Blood Curse. When the diseased creature takes a Long Rest, their Wisdom Score is reduced by 1, and then if their Wisdom Score is 8 or fewer, their symptoms progress to Stage Two. 

#### Stage Two
At Stage Two, the diseased creature's mania worsens, and their mucus develops into a thicker ooze-like fluid. Whenever the diseased creature reduces another creature to 0 or fewer Hit Points, they are compelled to consume that creature's corpse. If they do, their Charisma Score is reduced by 1. Otherwise, their Charisma Score is reduced by 3. When the diseased creature takes a Long Rest, if their Charisma Score is 8 or fewer, their symptoms progress to Stage Three.
...
When a Fledgling becomes a Childer, they gain their *Vampiric Legacy*. Their *Vampiric Legacy* is the same as their Sire's, if the Sire has one. If they don't, the Childer gains one of the following at random:
 - *Sulkar*. Vampires of *Sulkar*'s Legacy are subjected to their progenitor's obsession with Magic and Power, and the pact he made with the [[Arstovich]], granting them a modest reserve of inherent magic and an everlasting greed for knowledge. 
	 - A *Sulkar* cannot allow a mystical secret to be kept from them, and will obsessively pursue information regarding the magical effects of an item, spell, or otherwise magical phenomenon. 
	 - When you gain this *Legacy*, your Intelligence Score increases by 3, and you learn 6 spells of your choice that are 3rd level or less from the Wizard's Spell List. Your Intelligence is your Spellcasting Ability for these spells. 
	 - You may cast a Spell you know by spending an amount of Blood Tokens equal to their level instead of spending a Spell Slot, even if you do not have the *Spellcasting* Feature.
 - *Praetora*. Vampires of *Praetora*'s Legacy are subject to their progenitor's boiling rage, granting them a physical strength unique to their Legacy, packaged with a similarly unique sense of righteousness.
	 - A *Praetora* cannot allow dissent or disrespect in any form without genuine effort to calm themselves, and when they cannot stand it, will violently remove the threat to their authority. 
	 - When you gain this *Legacy*, your Strength increases by 5, your Wisdom is reduced by 2, and when you would add your Strength Modifier to an Attack or Damage roll, you add twice that number instead. 
	 - When you are slighted or disrespected, make a Wisdom Saving Throw, the DC of which is equal to 20 minus the total of your current Blood Tokens and Vampiric Progression. If you fail, you gain a Contempt against the entity that caused the disrespect. 
	 - You must reestablish your authority over anyone who you Contempt at any opportunity. If you ever have more Contempt for one entity than your Wisdom Modifier, you will become overcome with rage, and the need to destroy that entity in perpetuity.
 - *Brechan*. Vampires of *Brechan*'s Legacy are subjected to their progenitor's powerful perception - said to be capable of seeing the future - accompanied by their compulsive paranoia. 
	 - A *Brechan* cannot allow their secrets to be revealed - even one as simple as their name, let alone their plans of action - lest their paranoia spiral for what could be done with such information. 
	 - When you gain this *Legacy*, your Wisdom Score increases by 3, when you would add your Wisdom Modifier to an Ability Check, you add twice that number instead, and when any player (including the DM) rolls any die, you may spend a Vampiric Progression to make them reroll that die and take the second result. 
	 - When you have reason to believe a secret of yours has been revealed, unless you are revealing it to someone you Trust, make a Wisdom Saving Throw, the DC of which is equal to 20 minus the total of your current Blood Tokens and Vampiric Progression. If you fail, or if your secret was revealed by someone you Trust, you must recover your secret from those who should not know by any means necessary.
 - *Yona*. Vampires of *Yona*'s Legacy are subjected to their progenitor's disorganized mind and blindness for consequence, acting on instinct where others would choose careful plotting and planning. 
	 - A *Yona* cannot truly grasp a "greater picture" of a plan, no matter how many times it is explained to them, they will respond exclusively to their needs and impulses at the moment they experience them. 
	 - When you gain this *Legacy*, your Dexterity Score increases by 5, your Intelligence is reduced by 2, your walking speed increases by 10', you do not provoke Opportunity Attacks when you move, and you have Disadvantage on Wisdom Saving Throws.
 - *Richet*. Vampires of *Richet*'s Legacy are subjected to their progenitor's unending desire for the positions of authority that others possess - an intense coveting of Power, and an embrace of their most primal desire to command. 
	 - A *Richet* is always plotting their rise to power, be it over their party, nation, or eventually, the world - all from the shadowy corner of the room. 
	 - When you gain this *Legacy*, your Charisma Score increases by 3, and as a Bonus Action, you can spend a Blood Token to cast *darkness* or, if you are standing in Dim Light or Darkness, teleport 60' into an unoccupied space you can see that is also in Dim Light or Darkness.
	 - While you are in Bright Light, you have Disadvantage on Attacks, Ability Checks, and Saving Throws.
 - *Vollia*. Vampires of *Vollia*'s Legacy are subjected to their progenitor's intense vanity and their constant desire for pampering comfort. 
	 - A *Vollia* cannot stand even modest standards of living, requiring the most lavish comforts before they could consider themselves even slightly comfortable. 
	 - When you gain this *Legacy*, your Charisma Score increases by 3, when you would add your Charisma Modifier to an Ability Check, you add twice that number instead, and you may have any number of Bonds.
	 - When you would consume blood from a humanoid or fey, unless they consent (to some degree) to your actions, you gain no Blood Tokens from doing so.
 - *Morris*. Vampires of *Morris*' Legacy are subjected to their progenitor's need for drama and intrigue, and their compulsion to gather the secrets of others. 
	 - A *Morris* disregards any and all expectations of privacy for the sake of their compulsion, and values these secrets as powerful currency, second only to the invaluable Favor. 
	 - When you gain this *Legacy*, your Charisma increases by 3, and you can spend a Blood Token to cast *detect thoughts* at Touch range. 
	 - Whenever you learn a secret, make a Wisdom Saving Throw, the DC of which is equal to 20 minus the total of your current Blood Tokens and Vampiric Progression. If you fail, you must use this secret to your advantage within 72 hours.
 - *Talling*. Vampires of *Talling*'s Legacy are subjected to their progenitor's absolute moral apathy and utilitarianism. 
	 - A *Talling* has no friends, and no enemies. Only those who help and those who hinder; those who may continue and those who must be halted. A *Talling* is motivated by the needs of their Plan alone, unless they are called to act upon a Favor they owe. 
	 - When you gain this *Legacy*, your Constitution Score increases by 3, and when you or an ally you can see within 30' is the target of a harmful Attack, Ability, or Spell, you may spend any number of Blood Tokens to reduce or increase the roll to hit or avoid by the number of Blood Tokens spent.
	 - You gain a Plan that motivates your actions (such as "Maintain a new colony", or "Destroy the Arthurian state"). If your plan is ever fully realized, you gain another, grander Plan (such as "Understand Vampirism", or "Rule all").

A Childer can spend Blood Tokens in the following manners. You may only spend a whole number of Blood Tokens this way.
 - As an Action, spend any number of Blood Tokens. When you do, you roll and expend a hit die to regain a number of hit points equal to the result plus your Con for each Blood Token you spent.
...
A Dhampir can spend Blood Tokens in the following manners. You may only spend a whole number of Blood Tokens this way.
 ...
 - As a Movement, spend three Blood Tokens. When you do, you fly up to 90', during which your size is Tiny, you do not provoke Opportunity Attacks, and you can move through spaces occupied by other creatures.
...
A Dhampir can spend Bestial Progression in the following manners.
 ...
 - During a Long Rest, spend ten Vampiric Progression. When you do, choose and gain a *Vampiric Legacy* you don't already have. Then, you are incapacitated for 48 hours.
...
When a Dhampir is reduced to 0 or fewer Hit Points, if they have any Blood Tokens and the damage that reduced them to 0 or fewer was not fire or radiant damage, those Blood Tokens are consumed, and the Dhampir becomes incapacitated. Otherwise, if they have no Blood Tokens, they die and are reduced to ash. When a Dhampir is incapacitated this way, they can be killed by piecing their heart with wood or mithril, or exposing the Dhampir to direct sunlight. While a Dhampir is incapacitated this way, they can regain a Hit Point by being laid to rest in their lair for 28 uninterrupted days.
...
At Stage Two-A, the Lycanthrope has experienced a number of *Transformations*, during which they have shown control over their *Bloodlust*
