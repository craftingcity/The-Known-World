...
- **Anita's Dresser & Dolls**
	...
	- On the top of the dresser, the following set of six knitted character plushies are carefully positioned such that they all face the bed, and none would fall if disturbed;
		- A white rabbit-like creature with a black head and ears. It is wearing a black collar with pink spots.
		- A chubby yellow dog with a cute smile. It is wearing a brown beret.
		- A white rabbit-like creature with a pink head and ears. It is carrying a large wrapped candy.
		- A white cat with black eyes and whiskers. It is wearing a red bow.
		- A chubby white dog with blue eyes, large floppy ears, and a curled tail.
		- A green frog with large eyes and a cute blush. It is wearing a stripped brown and green shirt.
- **Anita's Bookshelf**
	- A large bookshelf is completely filled with academic and arcane textbooks. Each of the books is damaged to some degree, ranging from minor marks or scratches to major water or spillage damage.
...
- **Otto's Safe**
	- Hidden below the large Bed, an Arcane Safe ho
- **Otto's Bed**
	- 
...
- **Washbasin & Tools**
	- A large steel basin holds a set of sponges and bottled soaps.
- **Bucket Funnel System**
	- A tall box produces water from a tap on the outside. Below the tap, a steel bucket rests.
- **Privacy Chamber**
	- A simple wooden scaffold is covered in linens to create a separated section of the room. Inside the chamber, a ceramic waste-pot and minor cleaning supplies rest.
